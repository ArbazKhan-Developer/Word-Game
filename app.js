...
function showwords(){
    let words = ['mangoes','banana','python','last','knock','know','market','guess','never','uncle','nice','video','view','victory','zone','quote','large','justice','quality','quit','yellow','year','weather','let','past','flag','river','drive','welth','toy','produce','popular','cool','type','please','people','eight','yard','week','judge','income','joy','under','forest','formal','height','home','link','wash','finger','hair','control','run','effect','profit','test','sick','sent','right','way','melt','buy','civil','else','holy','impact','knife','able','accept','after','before','ago','alive','alone','angry','beauty','below','big','born','boss','bright','busy','catch','center','desire','display','distance','effort','field','garden','grow','hang','honor','impress','journey','lady','leave','length','mental','mixture','notice','nose','opinion','order','over','owner','parent','permit','piece','relax','reply','save','score','smart','tall','thick','urban','value','virus','widely','wind','yield','wrong','total','shut','proper','monitor','inspire','glad','exist','count','bank','metro','effort','hunt','tremble','price','admire','snore','try','dizzy','rely','pretend','tough','cost','still','worth','random','hear','poems','child','story','bowl','air','fan','bottom','pain','self','give','tomato','eye','sight','stare','grand','mother','comb','scare','demo','too','them','class','grade','code','feature','vehicle','road','mobile','space','star','little','mouse','advise','area','bite','cap','stack','pillow','sheet','machine','honest','poor','rich','harm','bucket','floor','skin','cry','bin','hour','broad','circle','clue','debt','dig','dry','elite','exact','fear','gap','grant','infant']
